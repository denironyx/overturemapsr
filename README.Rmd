...
-   `get_all_overture_schema_types`: This function returns all available OvertureMaps theme types.
...
-   schema_type: Character. Required. The type of feature to select. Examples include 'building', 'place', etc. To learn more, run get_all_overture_schema_types().
-   release_date: Character. Optional. The dataset release date (format: 'YYYY-MM-DD'). Defaults to the latest available release '2025-01-22' - https://docs.overturemaps.org/release/latest/
...
[Kyle Walker](https://walker-data.com/posts/overture-buildings/). Kudos!!!
